...
# Test 04:
if [[ $($CALCULATOR 10 - 4) -ne 6 ]]; then  # If the output of the program is not 2...
  echo 'ERROR! A valid run of the calculator (10 - 4) failed to produce 6 as an output!'
  exit 1
fi
